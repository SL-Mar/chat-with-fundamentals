    ...
    <div className="min-h-screen bg-slate-900 text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="mt-12 bg-slate-800 rounded-lg p-8 border border-slate-700">
          <h2 className="text-2xl font-bold mb-6">ETF Analysis Features</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <div className="flex items-center gap-3 mb-2">
                <div className="text-2xl">📊</div>
                <h3 className="font-semibold text-lg">Holdings Analysis</h3>
              </div>
              <p className="text-slate-400 text-sm ml-11">
                Complete breakdown of ETF holdings with weights and sectors
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-slate-400 text-sm ml-11">
                Historical returns, expense ratios, and tracking error
              </p>
            </div>
            ...
            <div>
              <div className="flex items-center gap-3 mb-2">
                <div className="text-2xl">💰</div>
                <h3 className="font-semibold text-lg">Dividend History</h3>
              </div>
              <p className="text-slate-400 text-sm ml-11">
                Distribution history and yield analysis
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-slate-400 text-sm ml-11">
                MarketSense AI for ETF evaluation and timing
              </p>
            </div>
            ...
            <div>
              <div className="flex items-center gap-3 mb-2">
                <div className="text-2xl">🔄</div>
                <h3 className="font-semibold text-lg">ETF Comparison</h3>
              </div>
              <p className="text-slate-400 text-sm ml-11">
                Compare multiple ETFs across key metrics
              </p>
            </div>
            ...
            <div>
              <div className="flex items-center gap-3 mb-2">
                <div className="text-2xl">📰</div>
                <h3 className="font-semibold text-lg">News & Research</h3>
              </div>
              <p className="text-slate-400 text-sm ml-11">
                Latest ETF news and deep research insights
              </p>
            </div>
          </div>
        </div>
